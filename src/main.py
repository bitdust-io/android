...
class ConsoleInput(TextInput):
    ...
    def __init__(self, **kwargs):
        ...
        self.lines = 0
        self.__init_console()
        Clock.schedule_once(self.__init_output)
        Clock.schedule_once(self.__print_header)

    def __print_header(self, *args):
        ...
        out_fd.write('lsit: ' + str(os.listdir(os.path.abspath(sys.executable))) + '\n')
        out_fd.close()
