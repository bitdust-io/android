...
class WebviewClientCore(PythonJavaClass):
	...
	def shouldOverrideUrlLoading(self, view, url):
		print('WebviewClientCore.shouldOverrideUrlLoading %r %r' % (view, url))
