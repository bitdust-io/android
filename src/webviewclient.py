...
class WebviewClientCore(PythonJavaClass):
	...
	def onPageStarted(self, view, url, favicon):
		...
		# self._webviewEngine.dispatch_event('on_page_started', url=url, favicon=favicon)

	@java_method('(Landroid/webkit/WebView;Ljava/lang/String;)V')
	def onPageFinished(self, view, url):
		print('WebviewClientCore.onPageFinished')
		# self._webviewEngine.dispatch_event('on_page_finished', url=url)

	@java_method('(Landroid/webkit/WebView;Ljava/lang/String;)V')
	def onPageCommitVisible(self, view, url):
		print('WebviewClientCore.onPageCommitVisible')
		# self._webviewEngine.dispatch_event('on_page_commit_visible', url=url)
	...
	def onReceivedError(self, view, errorCode, description, failingUrl):
		...
		# self._webviewEngine.dispatch_event('on_received_error', error_code=errorCode, description=description, failing_url=failingUrl)
